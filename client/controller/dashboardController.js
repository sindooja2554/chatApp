// chatApp.controller("dashboardController", function($scope,dashboardService) 
// {
//     $scope.users= data;
//     var users=$scope.users;

//     dashboardService.dashboard(users,$scope);
// });
...
chatApp.controller('chatController', function ($scope, SocketService, $state, chatServices) {
    ...
    if (token === null) 
    {     //if the token is null then redirects to login page
        $state.go('login');
    }
    try 
    {
